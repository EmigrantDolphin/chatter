...
silent only
silent tabonly
cd /mnt/c/Users/Norman/Desktop/secret
...
silent! normal! zE
let s:l = 55 - ((48 * winheight(0) + 30) / 60)
...
exe 'vert 3resize ' . ((&columns * 20 + 118) / 237)
argglobal
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists("mainPage.js") | buffer mainPage.js | else | edit mainPage.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
